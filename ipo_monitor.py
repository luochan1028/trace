...
COMPANIES = [
    ...
    },
    {
        ...
        "status": "VIE拆除",
        "status_color": "yellow",
        "progress_detail": "5月18日启动VIE及红筹架构拆除，预计Q3递表港交所，Q4挂牌上市",
        "board": "港交所",
        "valuation": "新融资后估值约300亿美元（2000亿人民币），上一轮43亿美元（6个月暴涨7倍）",
        "core_logic": "Kimi大模型领军者。2025年12月C轮5亿美元（IDG/阿里/腾讯/美团），2026年3月ARR破1亿美元，4月超2亿美元。全球付费用户月增速170%，海外API收入增长4倍",
        "risk": "尚未正式递交招股书，时间表仍有不确定性；大模型赛道竞争激烈（智谱/MiniMax/DeepSeek/阶跃星辰）；创始人虽表态不以上市为目的，但资本退出压力存在",
        "last_update": "2026-06-08",
        "milestones": [
            {"date": "2025-12-31", "event": "C轮5亿美元融资，投后估值43亿美元"},
            {"date": "2026-03-01", "event": "ARR突破1亿美元"},
            {"date": "2026-05-18", "event": "启动VIE及红筹架构拆除，扫清赴港IPO障碍"},
            {"date": "2026-07-15", "event": "预计港交所递表（估算）"},
            {"date": "2026-11-15", "event": "预计挂牌上市（估算）"},
        ],
    },
    {
        "name": "平头哥",
